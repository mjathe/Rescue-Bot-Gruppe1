...
private:
	...
	void EngineController::engine(int engine1, int engine2)		//Engine1 = right Engine2 = left
	{
		if (engine1 == 100)
		{
	...
	void EngineController::acclerator(int direction)
	{
		switch (direction)
		{
	...
	void EngineController::rotation(int angle)
	{
		if (angle <= 180)
		{
